...
function createChatBox(chatboxtitle,minimizeChatBox) {
	...
	.addClass("chatbox")
	.html('<div class="chatboxhead"><div class="chatboxtitle">'+chatboxtitle+'</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">X</a></div>'+
	'<br clear="all"/><a href="javascript:void(0)" onclick="javascript:webcam(\''+chatboxtitle+'\');">webcam</a> '+
	'<a href="javascript:void(0)" onclick="javascript:block(\''+chatboxtitle+'\');">Block</a> '+
